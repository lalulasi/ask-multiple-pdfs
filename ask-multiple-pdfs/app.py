...
def get_vectorstore(text_chunks):
    # embeddings = AzureOpenAIEmbeddings(azure_deployment="textEmbedding", openai_api_version="2023-09-01-preview",)
    embeddings = OpenAIEmbeddings(deployment="textEmbedding")
